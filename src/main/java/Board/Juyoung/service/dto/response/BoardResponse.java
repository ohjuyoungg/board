...
public record BoardResponse(Long memberId, String nickname, Long boardId, String title, String content, String imageUrl,
    ...
    public static BoardResponse of(Board board, List<CommentResponse> comments) {
        ...
        return new BoardResponse(member.getId(), member.getNickname(), board.getId(), board.getTitle(),
            board.getContent(), board.getImageUrl(), comments
        );
    }
}
